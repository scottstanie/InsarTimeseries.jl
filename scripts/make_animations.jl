...
geolist78 = Sario.load_geolist_from_h5(
    "/Users/scott/Documents/Learning/masters-thesis/zoom_images78/stack_max700_alpha100.h5",
    "stack/1",
);
...
animate_imgs_vs_pts(
    ...
    vm = 6,
    c = "r",
    outname = "animation_texnet78.gif",
)
animate_imgs_vs_pts(
    stack78,
    [eqs15; eqs17],
