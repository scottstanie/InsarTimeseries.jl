...
_to_str(dpair::Tuple{Date, Date}, ext) = Dates.format(dpair[1], dfmt)*"_"*Dates.format(dpair[2], dfmt) * ext


function avg_files(geolist::AbstractArray, intlist::AbstractArray, ext::String=".unw", outdir::String="avg_igrams/")
